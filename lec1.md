...
- rect(float x, float y, float w, float h): 四角形の左上頂点(x, y)とし，幅w，高さhの長方形を描く
  - 幅と高さを同じ値にすると正方形を描く
  - 例: rect(50, 20, 10, 60) # 左上の座標(50, 20)と幅10，高さ60の長方形を描く
- ellipse(float x, float y, float w, float h): 中心座標(x, y)とし，幅w，高さhである楕円を描く
